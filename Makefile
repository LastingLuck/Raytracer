...
$(OBJ)/main.o: src/main.cpp
	$(CC) $(CFLAGS) $(DFLAGS) $(LFLAGS) src/main.cpp -o $@

$(OBJ)/parse.o: src/parse.cpp
	$(CC) $(CFLAGS) $(DFLAGS) $(LFLAGS) src/parse.cpp -o $@

$(OBJ)/raytrace.o: src/raytrace.cpp
	$(CC) $(CFLAGS) $(DFLAGS) $(LFLAGS) src/raytrace.cpp -o $@

$(OBJ)/image.o: src/image.cpp
	$(CC) $(CFLAGS) $(LFLAGS) src/image.cpp -o $@

$(OBJ)/pixel.o: src/pixel.cpp
	$(CC) $(CFLAGS) $(LFLAGS) src/pixel.cpp -o $@

$(OBJ)/EasyBMP.o: src/EasyBMP.cpp
	$(CC) $(CFLAGS) $(LFLAGS) src/EasyBMP.cpp -o $@
